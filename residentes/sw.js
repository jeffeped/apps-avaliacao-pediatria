const CACHE='residped-uea-v10';
const FILES=['../shared/attendance-records.js','../shared/attendance-records.css','./','./index.html','./manifest.webmanifest','./icon.svg','./admin-evaluations.js','./admin-resident-feedback.js','./admin-evaluations.css'];
