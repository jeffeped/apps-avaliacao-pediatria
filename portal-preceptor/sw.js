const CACHE='portal-preceptor-v8';
const FILES=['./','./index.html','./manifest.webmanifest','./icon.svg','./vendor/pdf-lib.min.js','./evaluation-pdf.js','./evaluation-exports.js','./assets/uea-logo-verde.pdf'];
